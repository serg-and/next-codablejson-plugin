...
import { foo as _NEXT_CODABLEJSON_IMPORTED_PROPS, default as Page } from 'source';
const _NEXT_CODABLEJSON_SSG_PROPS = _withCodableJSONProps(_NEXT_CODABLEJSON_IMPORTED_PROPS, [
    "smth"
]);
