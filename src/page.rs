...
static CODABLEJSON_PROPS_IMPORTED: &str = "withCodableJSONProps";
pub static CODABLEJSON_PROPS_LOCAL: &str = "_withCodableJSONProps";

// import { withCodableJSONInitProps as _withCodableJSONInitProps } from "next-codablejson-plugin/tools";
static CODABLEJSON_INIT_PROPS_IMPORTED: &str = "withCodableJSONInitProps";
pub static CODABLEJSON_INIT_PROPS_LOCAL: &str = "_withCodableJSONInitProps";

// import { withCodableJSONPage as _withCodableJSONPage } from "next-codablejson-plugin/tools";
static CODABLEJSON_PAGE_IMPORTED: &str = "withCodableJSONPage";
pub static CODABLEJSON_PAGE_LOCAL: &str = "_withCodableJSONPage";

// import { not_gSSP as _NEXT_CODABLEJSON_IMPORTED_PROPS } from '..'
// const  _NEXT_CODABLEJSON_SSG_PROPS = wrap(_NEXT_CODABLEJSON_IMPORTED_PROPS)
// export { _NEXT_CODABLEJSON_SSG_PROPS as gSSP }
pub static NEXT_SSG_PROPS_LOCAL: &str = "_NEXT_CODABLEJSON_IMPORTED_PROPS";
pub static NEXT_SSG_PROPS_ORIG: &str = "_NEXT_CODABLEJSON_SSG_PROPS";

// import { unwrapped as _NEXT_CODABLEJSON_IMPORTED_PAGE } from 'src'
// export default wrap(_NEXT_CODABLEJSON_IMPORTED_PAGE)
static NEXT_PAGE_LOCAL: &str = "_NEXT_CODABLEJSON_IMPORTED_PAGE";
...
impl VisitMut for PageTransformer {
    fn visit_mut_module_items(&mut self, items: &mut Vec<ModuleItem>) {
                ...
                && !self.props.skip
            {
                match item {
                    ...
                    ModuleItem::ModuleDecl(ModuleDecl::Import(ImportDecl {
                        ...
                        // =>
                        // imported: not_gSSP, local: _NEXT_CODABLEJSON_IMPORTED_PROPS
                ...
                if !self.props.skip && pos == self.props.export.orig.unwrap() {
                    match item {
                        ...
                        ModuleItem::ModuleDecl(ModuleDecl::ExportNamed(NamedExport {
                            ...
                            // =>
                            // import { not_gSSP as _NEXT_CODABLEJSON_IMPORTED_PROPS } from '..'
                            // const _NEXT_CODABLEJSON_SSG_PROPS = wrap(_NEXT_CODABLEJSON_IMPORTED_PROPS, excluded)
                            // export { _NEXT_CODABLEJSON_SSG_PROPS as gSSP }
                            if let Some(src) = src {
                                let s = specifiers
                            ...
                            // export { _NEXT_CODABLEJSON_SSG_PROPS as gSSP }
                                ...
                                // case 1: imported
                                // import { not_gSSP as _NEXT_CODABLEJSON_IMPORTED_PROPS }
                                // => _NEXT_CODABLEJSON_SSG_PROPS
                                //
                                // case 2: local
                                // const gSSP = () => {}
                                // => gSSP
        ...
        if !self.props.skip {
            prepend_stmt(
                &mut new_items,
                codablejson_import_decl(CODABLEJSON_PROPS_IMPORTED),
            );
        }
        if self.use_init_props {
            prepend_stmt(
                &mut new_items,
                codablejson_import_decl(CODABLEJSON_INIT_PROPS_IMPORTED),
            );
        }
        if !self.page.skip {
            prepend_stmt(
                &mut new_items,
                codablejson_import_decl(CODABLEJSON_PAGE_IMPORTED),
            );
        }
